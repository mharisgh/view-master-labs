  ...
  return (
    <main className="transition min-h-[92vh] lg:min-h-screen flex flex-col justify-between">
      ...
      <motion.nav
        ...
        className='flex justify-between pt-4 lg:px-10 px-4 items-center'>
      ...
      <div className='flex flex-col gap-4 lg:-mt-[6rem] lg:gap-10'>
        ...
        <motion.div
          ...
          className={`${myFont.className} text-center text-[1.3rem]  md:text-[3rem] `}>
        ...
        <div className="flex flex-col gap-4">
          ...
          <motion.div
            ...
            <img src="vr.webp" className='animate-[device_10s_ease-in-out_infinite]  z-10 md:max-w-[600px] lg:max-w-[800px]' alt="" />
          ...
          <motion.p
            ...
            className={`${myFont.className} text-center mt-6 lg:text-xl text-base  leading-tight`}>Our Website Is Getting a <span className='text-green-500'>Makeover</span><br></br>
            For inquiries or projects, contact us
          </motion.p>
      ...
      >
        ...
        <div
          className='gap-4 lg:mb-4 lg:gap-0 w-full flex flex-col lg:flex-row justify-between px-10 items-center '>
